...
OpenGLVirtualCameras::OpenGLVirtualCameras(QWidget *parent)
...
OpenGLVirtualCameras::~OpenGLVirtualCameras()
{
...
void OpenGLVirtualCameras::resizeEvent(QResizeEvent* event)
{
	// 绘制的大小
...
bool OpenGLVirtualCameras::event(QEvent* event)
{
	// 接受事件判断是否是自己的渲染函数
...
bool OpenGLVirtualCameras::initializeGL()
{

	program = CreateGpuProgram("assets/virtualcameras/vertexShader.glsl", "assets/virtualcameras/frag/fragmentShader.glsl");
	...
	//////////////////////////////VAO 解绑后操作texcoord//////////////////////////////////////////
	QImage img = QImage("assets/virtualcameras/we.jpg");
	tex1 = CreateGLTexture(GL_TEXTURE_2D, img.width(), img.height(), GL_RGBA, GL_BGRA, img.bits());

	QImage img2 = QImage("assets/virtualcameras/we.jpg");
...
bool OpenGLVirtualCameras::CreateGLContext()
{
	dc = GetDC(hwnd);
...
bool OpenGLVirtualCameras::_gl_update()
{
	QApplication::postEvent(this, new QtEvent(QtEvent::GL_Renderer));
	return true;
}
...
void OpenGLVirtualCameras::Renderer()
{
