...
#include "ui_OpenGLVirtualCameras.h"
#include <Windows.h>
#include <GL/eglew.h>
#include "QtEvent.h"
#include "cutil.h"
#include "camera.h"
class OpenGLVirtualCameras : public QWidget
{
    Q_OBJECT

public:
    OpenGLVirtualCameras(QWidget *parent = nullptr);
    ~OpenGLVirtualCameras();
...
private:
    ...
    bool _gl_update();
private:
    Ui::OpenGLVirtualCamerasClass ui;
    HDC dc;
    HGLRC rc;
    HWND hwnd;
