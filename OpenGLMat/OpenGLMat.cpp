...
OpenGLMat::OpenGLMat(QWidget *parent)
...
void OpenGLMat::resizeEvent(QResizeEvent* event)
{
	// 绘制的大小
...
bool OpenGLMat::event(QEvent* event)
{
	// 接受事件判断是否是自己的渲染函数
...
bool OpenGLMat::initializeGL()
{

	program = CreateGpuProgram("assets/mat/vertexShader.glsl", "assets/mat/frag/fragmentShader.glsl");
...
bool OpenGLMat::CreateGLContext()
{
	dc = GetDC(hwnd);
