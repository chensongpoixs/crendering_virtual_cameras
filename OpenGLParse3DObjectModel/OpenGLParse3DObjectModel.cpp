...
bool OpenGLParse3DObjectModel::initializeGL()
{
	...
	//shader = new chen::cshader1("assets/parse3dobjectmodel/vertexShader2.glsl", "assets/parse3dobjectmodel/frag/fragmentShader2.glsl");
	...
	QImage img2 = QImage("assets/parse3dobjectmodel/tex1.jpg");
